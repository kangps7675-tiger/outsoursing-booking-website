    ...
    <>
      ...
      <div className="auth-wrap">
        ...
        <div className="auth-card">
          ...
          <h1>다시 오신 걸 환영해요</h1>
          <p>출처 기반 리포트 코파일럿을 계속 사용하려면 로그인해 주세요.</p>
          <form onSubmit={(e) => { e.preventDefault(); alert('로그인 데모 화면입니다.'); }}>
            <label>이메일</label>
      ...
      <style jsx>{`
        ...
        .auth-card{position:relative;z-index:1;width:100%;max-width:430px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:30px;box-shadow:0 14px 36px rgba(15,23,42,.10)}
